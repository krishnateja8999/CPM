...
@Component({
  selector: 'app-grn-discrepancies',
  templateUrl: './grn-discrepancies.component.html',
  styleUrls: ['./grn-discrepancies.component.scss']
})
export class GrnDiscrepanciesComponent implements OnInit {
