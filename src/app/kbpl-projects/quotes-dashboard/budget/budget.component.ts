...
import { AddActivityDialogComponent } from 'src/app/mrc-projects/project-planning/activities/add-activity-dialog/add-activity-dialog.component';
import { AddLineItemDialogComponent } from 'src/app/mrc-projects/project-planning/activities/add-line-item-dialog/add-line-item-dialog.component';
import { UpdateDataDialogComponent } from 'src/app/mrc-projects/project-planning/activities/update-data-dialog/update-data-dialog.component';
import { TreeService } from 'src/app/mrc-projects/project-planning/tree.service';
import { SiteStatusDialogComponent } from './site-status-dialog/site-status-dialog.component';
import { SowStatusDialogComponent } from './sow-status-dialog/sow-status-dialog.component';
...
public openSowDailog() {
  let dialogRef = this.dialog.open(SowStatusDialogComponent, {
      data: false,
      height: 'auto',
      width: '1055px',
      disableClose: true
...
public openSiteDailog() {
  let dialogRef = this.dialog.open(SiteStatusDialogComponent, {
      data: false,
      height: 'auto',
      width: '1055px',
      disableClose: true
