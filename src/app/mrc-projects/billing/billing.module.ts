import { DocumentsAndDrawingModule } from './../documents-and-drawing/documents-and-drawing.module';
...
export const routes = [
  ...
  { path: 'client-ra-bills', component:ClientRaBillsComponent, data: { breadcrumb: '' } },
  { path: 'reconciliation', component:ReconciliationsComponent, data: { breadcrumb: '' } },
  { path: 'sub-contractors', component:SubContractorsComponent, data: { breadcrumb: '' } },
  { path: 'sc-advances', component:SCComponent, data: { breadcrumb: '' } },
  { path: 'sc-ra-bills', component:SCRABillsComponent, data: { breadcrumb: '' } },
  { path: 'testing', component:TestingComponent, data: { breadcrumb: '' } },
];
