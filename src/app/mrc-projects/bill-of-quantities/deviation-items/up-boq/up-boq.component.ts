...
@Component({
  selector: 'app-up-boq',
  templateUrl: './up-boq.component.html',
  styleUrls: ['./up-boq.component.scss']
})
export class UpBoqComponent implements OnInit {
  ...
  constructor(private _formBuilder: FormBuilder,public dialogRef: MatDialogRef<UpBoqComponent>) {}
